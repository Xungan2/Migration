...
仅描述旧工作区/后续阶段的兼容机制。自主 P0 见[当前约定](../p0-three-loops.md)。
...
**接线范围**：本页记录后续旧阶段的调用协议；自主 P0 由持续会话直接执行。
...
| 🟡 机械可换（9） | P1D 划分 / P1R 解环 / P2a 映射 / P3 增量映射+gap+判据（3 处）/ P4 fill / P5 补探 / P6 draft-l4 | run_agent_structured |
| ⚪ 无必要（5） | P1S 策略 / routing 关口应答（2 处）/ CP5 分类 | 纯单发，老接口够用 |
